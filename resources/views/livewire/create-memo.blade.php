    ...
    <div class="mt-12 p-4">
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid">
                ...
                <input wire:model="title" class="border-2 w-96 border-gray-400 focus:outline-none focus:border-blue-400 h-12 rounded-xl px-4" type="text">
                @error('title')
            ...
            <div class="grid">
                ...
                <div class="flex gap-2 items-center">
                    <textarea wire:model="info" rows="10" class="border w-3/4 border-gray-400 focus:outline-none focus:border-2 focus:border-blue-400 rounded-xl px-4"></textarea>
                    @error('info')
